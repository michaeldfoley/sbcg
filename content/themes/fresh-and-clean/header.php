...
<div id="header">
  ...
  <div id="header-logo">
 			 <?php if($options['logo'] !='') { ?>
            	<a href="<?php bloginfo( 'url' ) ?>/" title="<?php bloginfo( 'name' ) ?>" rel="home"><img src="<?php echo get_template_directory_uri().'/images/'.$options['logo']; ?>" alt="<?php bloginfo( 'name' ) ?>" /></a>
           	 <?php } else { ?>
   ...
   <?php /*
    <div id="header-donate">
                            ...
                            <form method="post" action="" name="paypalform">
                                <input type="hidden" onfocus="if(value==defaultValue)value=''" onblur="if(value=='')value=defaultValue" value="" name="non_paid_enter"  id="non_paid_enter" />
...
<?php /* Widgetized sidebar 
    if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('HomeAlerts') ) : ?><?php endif; ?>
*/?>
<div class="home-alert">
<h1>RECENT NEWS</h1>
<?php

$args = array( 'numberposts' => 2, 'category'=>'14', 'order'=> 'DESC', 'orderby' => 'date' );
